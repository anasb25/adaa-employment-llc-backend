...
export class TimesheetsModded1766473386085 implements MigrationInterface {
    name = 'TimesheetsModded1766473386085'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "timesheets" DROP COLUMN "allocationId"`);
        ...
        await queryRunner.query(`ALTER TABLE "timesheets" ADD "projectId" integer NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "timesheets" ADD CONSTRAINT "FK_5b9766964a22eb894b167dd2052" FOREIGN KEY ("projectId") REFERENCES "projects"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "timesheets" DROP CONSTRAINT "FK_5b9766964a22eb894b167dd2052"`);
        ...
        await queryRunner.query(`ALTER TABLE "timesheets" DROP COLUMN "projectId"`);
        ...
        await queryRunner.query(`ALTER TABLE "timesheets" ADD "allocationId" integer`);
